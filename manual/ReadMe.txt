...
'3. Обработка отчетов из Аргуса и Онимы' из отчетов Аргуса и Онимы формирует таблицы, необходимые для выполнения запросов к базе данных.
'4. Получение данных для работы с Онимой (запустить 1 раз)' формирует таблицу с данными для работы с Онимой. Единожды построенная таблица дополняется при каждом запуске пункта 2.
