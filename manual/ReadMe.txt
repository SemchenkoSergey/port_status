...
'4. Получение данных для работы с Онимой и уточнение тарифов' формирует таблицу с данными для работы с Онимой, и проверяет тарифные опции по скорости (например "Ускоряйся", "Максимальная скорость канала").
