...
python3 Make_Abon_Dsl.py (запуск программы формирования таблицы с данными об абонентах abon_dsl)
python3 Make_Abon_Onyma.py (запуск программы формирования таблицы с данными для Онимы abon_onyma)
python3 Session_Count.py (запуск программы подсчета сессий)

Port_Status.py собирает данные независимо от других программ.
Перед выполнением запросов к базе данных без учета количества сессий необходимо сформировать таблицу с данными об абонентах, т.е. дать отработать программе Make_Abon_Dsl.py
Перед выполнением запросов к базе данных с учетом количества сессий необходимо запустить программы Make_Abon_Onyma.py (для формирования таблицы с данными Онимы), а затем Session_Count.py для проверки сессий за прошлый день.
