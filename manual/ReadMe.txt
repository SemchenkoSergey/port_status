...
python3 Make_Abon(Onyma).py (запуск программы формирования таблицы с данными об абонентах с запуском Онимы, нужно если будут отслеживаться абонентские сессии)
...
Перед запуском Session_Count.py дать отработать программе Make_Abon(Onyma).py
